    ...
    <section>
        <Container className="">
             <div className="grid relative 2xs:grid-cols-4 2xs:justify-between 2xs:items-center 2xs:px-2 xl:grid-cols-4 py-2  xl:justify-between xl:px-2 items-center">
                ...
                <div className="">
                   <div className="">
                        <img className='2xs:h-[20px] 2xs:w-[40px] xs:h-[30px] xs:w-[70px] sm:h-[40px] sm:w-[90px] md:h-[60px] md:w-[130px] lg:h-[70px] lg:w-[150px] xl:h-[30px] xl:w-[80px]' src={hekto} alt="" />
                   </div>
                </div>
