            ...
            <div className="">
                ...
                <div className="my-[64px]">
                  ...
                  <div className="group relative w-[270px] bg-[#F6F7FB] shadow-[0_0_15px_rgba(0,0,0,0.15)]">
                      ...
                      <div className="pt-[64px] w-[270px] flex justify-center">
                   ...
                   {/* <div className="group relative w-[270px] bg-[#F6F7FB] shadow-[0_0_15px_rgba(0,0,0,0.15)]">
                      ...
                      <div className="pt-[64px] w-[270px] flex justify-center">
                        <img src={feauter1} alt="feauter" />
                      </div>
                      <div className="flex justify-center opacity-0 group-hover:opacity-100">
                        <button className='text-[12px] bg-[#08D15F] hover:bg-[#00009D] text-[#ffff] rounded-[4px] w-[150px] py-3 my-2'>View Details</button>
                        </div>
                        <div className="bg-[#ffff] w-[270px] group-hover:bg-[#00009D]">
                        <div className="">
                        <h2 className='text-[#FB2E86] group-hover:text-[#ffff] text-[18px] font-bold font-Lato text-center py-2'>Cantilever chair</h2>
                        </div>
                        <div className="flex items-center justify-center gap-x-2 py-2">
                          <div className="h-[4px] w-[14px] bg-[#05E6B7]"></div>
                          <div className="h-[4px] w-[14px] bg-[#F701A8]"></div>
                        ...
                        <div className="">
                          <h4 className='text-[14px] text-[#151875] group-hover:text-[#ffff] font-Lato font-medium text-center py-2'>$42.00</h4>
                        </div>
                      </div>
                  </div>
